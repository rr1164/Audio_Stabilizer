...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QtClass_t, stringdata0) + ofs), len 
...
const QMetaObject QtClass::staticMetaObject = { {
    ...
    qt_meta_stringdata_QtClass.offsetsAndSize,
    qt_meta_data_QtClass,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QtClass_t
